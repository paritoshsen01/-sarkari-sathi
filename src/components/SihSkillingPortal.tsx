    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans pb-24">
      ...
      <header className="bg-white border-b-2 border-slate-200 sticky top-0 z-40 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3 cursor-pointer shrink-0" onClick={onBackToHome}>
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-white rounded-xl flex items-center justify-center shadow-md overflow-hidden border border-slate-100 shrink-0">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-xs text-slate-500">AI Voice Assistant for Livelihood & NSQF Recommendations</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1 sm:gap-2 shrink-0">
            ...
            <button 
              ...
              className="p-1.5 sm:p-2 text-slate-400 hover:text-primary-600 hover:bg-primary-50 rounded-full transition-colors relative group shrink-0"
              title="AI Settings"
            >
              <Settings className="w-4 h-4 sm:w-5 sm:h-5" />
              {!geminiApiKey && <span className="absolute top-1 right-1 w-1.5 h-1.5 sm:w-2 sm:h-2 bg-red-500 rounded-full animate-pulse"></span>}
            </button>

            <div className="relative flex items-center bg-slate-100 p-0.5 sm:p-1 rounded-full border border-slate-200 text-[10px] sm:text-xs font-bold mr-0 sm:mr-1 shrink-0">
              <select 
                value={selectedLang}
                onChange={(e) => {
            ...
            <button 
              ...
              className={`px-2 py-1 sm:px-3 sm:py-1.5 rounded-full text-[10px] sm:text-sm font-semibold transition-all shrink-0 ${
            ...
            <button 
              ...
              className={`px-2 py-1 sm:px-3 sm:py-1.5 rounded-full text-[10px] sm:text-sm font-semibold transition-all shrink-0 ${
                activeTab === 'roadmap' ? 'bg-primary-600 text-white shadow-sm' : 'text-slate-700 hover:bg-slate-100'
              }`}
            >
              {pt.navRoadmap}
            </button>
