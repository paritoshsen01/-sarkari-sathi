...
export const languages = {
  ...
  bun: {
    ...
    assistant: {
      ...
      questions: [
        "राम-राम! तुम कोन से राज्य में रहत हो?",
        "तुमारी उमर कत्ती है?",
  ...
  sat: {
    ...
    assistant: {
      ...
      processing: 'Thank you! Checking suitable schemes based on your information...',
      questions: [
        "Johar! Which state do you live in?",
        "What is your age?",
        "What is your primary occupation?",
        "What is your approximate annual family income?",
        "How many members are in your family?",
  ...
  spv: {
    ...
    assistant: {
      ...
      questions: [
        "Juhar! Apana kieun rajya re rahuchhanti?",
  ...
  bn: {
    ...
    assistant: {
      ...
      questions: [
        "নমস্কার! আপনি কোন রাজ্যে বাস করেন?",
        "আপনার বয়স কত?",
  ...
  bho: {
    ...
    assistant: {
      ...
      questions: [
        "प्रणाम! रउवा कवन राज्य में रहेनी?",
        "राउर उमिर केतना बा?",
        "राउर मुख्य काम का ह?",
